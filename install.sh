...
for pkg in exe/luajit-rocks exe/env exe/trepl extra/nn pkg/cwrap pkg/gnuplot pkg/image pkg/paths pkg/sundown pkg/sys pkg/torch pkg/paths pkg/xlua extra/argcheck extra/penlight extra/lua-cjson extra/luaffifb extra/luafilesystem pkg/dok pkg/optim extra/nnx extra/graph extra/nngraph; do {
