...
sudo apt-get install -y wget git gcc-4.9 g++-4.9 cmake cmake-curses-gui libffi-dev libblas-dev liblapack-dev gfortran libreadline-dev libprotobuf-dev protobuf-compiler libpng12-dev
