...
sudo apt-get install -y wget git gcc g++ cmake cmake-curses-gui libffi-dev libblas-dev liblapack-dev gfortran libreadline-dev libprotobuf-dev protobuf-compiler
